...
export const brands: BrandPage[] = [
  {
    ...
    slug: 'volkswagen',
    priceFrom: 300,
    lead: 'Оцениваем стекло Volkswagen по модели, году и фото, а сложную комплектацию при необходимости финально сверяем по VIN.',
    models: [
  ...
  },
  {
    ...
    notes: ['фото ускоряет первичную оценку', 'можно согласовать эконом и оптимум варианты', 'после замены даём рекомендации по выдержке'],
  },
  {
    name: 'Geely',
    slug: 'geely',
  ...
  },
  {
    ...
    slug: 'toyota',
    priceFrom: 300,
    lead: 'Toyota часто имеет разные варианты стекла под одну модель, поэтому начинаем с модели, года и фотографии стекла.',
    models: [
  ...
  },
  {
    ...
    slug: 'bmw',
    priceFrom: 420,
    lead: 'Для BMW критичны камеры, ассистенты, датчики, акустика и обогрев. Сначала оцениваем фото, затем при необходимости сверяем VIN.',
    models: [
      { name: 'X5', slug: 'x5' },
  ...
  },
  {
    ...
    notes: ['для сложной комплектации может понадобиться VIN', 'можно сравнить несколько производителей', 'аккуратно работаем с салоном и кузовом'],
  },
  {
    name: 'Mercedes-Benz',
    slug: 'mercedes-benz',
    priceFrom: 420,
    lead: 'Для Mercedes-Benz начинаем с модели, года и фото, учитываем камеры, ассистенты, обогрев, акустику и тип кузова.',
    models: [
  ...
  },
  {
    ...
    notes: ['уточняем поколение и рестайлинг', 'фото стекла ускоряет оценку', 'объясняем итоговую цену до записи'],
  },
];
